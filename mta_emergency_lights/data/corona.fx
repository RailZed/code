...
technique custom_corona0{
    pass P0  { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction00(); PixelShader = compile ps_2_0 PixelShaderFunction00(); }
    pass P1  { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction01(); PixelShader = compile ps_2_0 PixelShaderFunction01(); }
    pass P2  { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction02(); PixelShader = compile ps_2_0 PixelShaderFunction02(); }
    pass P3  { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction03(); PixelShader = compile ps_2_0 PixelShaderFunction03(); }
    pass P10 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction10(); PixelShader = compile ps_2_0 PixelShaderFunction10(); }
    pass P11 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction11(); PixelShader = compile ps_2_0 PixelShaderFunction11(); }
    pass P12 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction12(); PixelShader = compile ps_2_0 PixelShaderFunction12(); }
    pass P13 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction13(); PixelShader = compile ps_2_0 PixelShaderFunction13(); }
    pass P20 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction20(); PixelShader = compile ps_2_0 PixelShaderFunction20(); }
    pass P21 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction21(); PixelShader = compile ps_2_0 PixelShaderFunction21(); }
    pass P22 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction22(); PixelShader = compile ps_2_0 PixelShaderFunction22(); }
    pass P23 { SrcBlend = SRCALPHA; DestBlend = ONE; AlphaRef = 1; AlphaBlendEnable = TRUE; FogEnable = false; VertexShader = compile vs_2_0 VertexShaderFunction23(); PixelShader = compile ps_2_0 PixelShaderFunction23(); }
}
